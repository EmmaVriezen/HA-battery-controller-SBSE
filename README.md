...
2. Create 'recently charged to 100%' automation blueprint + make entity examples
3. Describe P1 reader integration setup + entities
4. Describe solar forecast integration setup + entities
